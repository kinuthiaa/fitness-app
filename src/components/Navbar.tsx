...
const Navbar = () => {
    ...
    return (
        ...
        <header className="fixed top-0 px-3 left-0 right-0 z-50 bg-background/60 backdrop-blur-md border-b border-border py-3">
            <div className="container mx-auto flex items-center justify-between">
                <Link href={"/"} className='flex items-center gap-2'>
                    ...
                    <span className="text-xl font-bold font-mono">
                        Fit<span className="text-primary">ness</span>
                    </span>
                </Link>
                ...
                <nav className="flex items-center gap-5">
                    ...
                    <SignUpButton>
                        <Button className="border-primary/50 text-white hover:text-primary hover:bg-primary/10">Sign Up</Button>
                    </SignUpButton>
                    </>
                    )}
                </nav>
